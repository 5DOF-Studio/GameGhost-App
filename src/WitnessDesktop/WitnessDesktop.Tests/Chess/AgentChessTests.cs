...
public class AgentChessTests
{
    ...
    [Fact]
    public void Leroy_CaptureThreshold_IsTunedForSingleMoveDetection()
    {
        Agents.Chess.CaptureConfig.DiffThreshold.Should().Be(4);
    }

    [Fact]
    public void Rasa_Tools_DoesNotContainChessTools()
    {
        // Adventure/RPG agent should NOT have chess tools
