...
public class VoiceConfigTests
{
    ...
    [Fact]
    public void GetVoiceName_WithVoiceId_ReturnsVoiceIdDirectly()
    {
        var result = VoiceConfig.GetVoiceName("openai", "male", voiceId: "echo");
        result.Should().Be("echo");
    }

    [Fact]
    public void GetVoiceName_WithNullVoiceId_FallsBackToGenderLookup()
    {
        var result = VoiceConfig.GetVoiceName("openai", "male", voiceId: null);
        result.Should().Be("ash");
    }

    [Fact]
    public void GetVoiceName_WithVoiceId_IgnoresGender()
    {
        var result = VoiceConfig.GetVoiceName("openai", "female", voiceId: "echo");
        result.Should().Be("echo");
    }

    [Fact]
    public void GetVoiceName_LegacyOverload_StillWorks()
    {
        VoiceConfig.GetVoiceName("openai", "male").Should().Be("ash");
        VoiceConfig.GetVoiceName("openai", "female").Should().Be("shimmer");
        VoiceConfig.GetVoiceName("gemini", "male").Should().Be("Fenrir");
