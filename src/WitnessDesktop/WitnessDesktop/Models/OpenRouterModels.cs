...
public class OpenRouterRequest
{
    ...
    /// Uses JsonElement to bypass STJ source generator limitations with mixed-type dictionaries.
    /// </summary>
    [JsonPropertyName("provider")]
    public JsonElement? Provider { get; set; }

    /// <summary>
    /// Response format specification for structured JSON output.
    /// Uses JsonElement to bypass STJ source generator limitations with nested schemas.
    /// </summary>
...
[JsonSerializable(typeof(BrainAnalysisResult))]
