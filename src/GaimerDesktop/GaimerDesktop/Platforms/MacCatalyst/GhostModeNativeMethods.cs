...
namespace GaimerDesktop.Platforms.MacCatalyst;

/// <summary>
/// P/Invoke declarations for GaimerGhostMode native Swift helper.
/// All 18 ghost_panel_* functions exported via @_cdecl from the xcframework.
...
internal static class GhostModeNativeMethods
{
    ...
    /// Parameters: toggleIndex (0=MIC, 1=AUTO, 2=AI-MIC), newValue.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    ...
    /// <summary>Syncs audio toggle states from C# to the native audio card.</summary>
    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void ghost_panel_set_audio_state(
        [MarshalAs(UnmanagedType.U1)] bool micActive,
        [MarshalAs(UnmanagedType.U1)] bool commentaryActive,
        [MarshalAs(UnmanagedType.U1)] bool aiMicActive);

    /// <summary>Dismisses the native audio control card.</summary>
    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void ghost_panel_dismiss_audio_card();
