...
public sealed class WindowCaptureService : IWindowCaptureService, IDisposable
{
    ...
    private const int DefaultCaptureIntervalMs = 30000; // Default: 1 frame per 30 seconds
    ...
    public Task StartCaptureAsync(CaptureTarget target, int captureIntervalMs = 30000)
    {
        lock (_gate)
        {
