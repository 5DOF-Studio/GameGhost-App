...
public partial class GaimerHudView : ContentView
{
    private MainViewModel? _viewModel;
    private System.Timers.Timer? _dismissTimer;

    public static readonly BindableProperty IsExpandedProperty =
        BindableProperty.Create(nameof(IsExpanded), typeof(bool), typeof(GaimerHudView), false,
    ...
    {
        if (bindable is GaimerHudView hud)
        {
