...
| Test project | `src/WitnessDesktop/WitnessDesktop.Tests/` |
| Build command | `dotnet build src/WitnessDesktop/WitnessDesktop.Tests/WitnessDesktop.Tests.csproj -f net8.0` |
| **Test execution** | **`dotnet test src/WitnessDesktop/WitnessDesktop.Tests/WitnessDesktop.Tests.csproj -f net8.0` (~11 seconds)** |
...
| Live Testing Sprint + Phase 13 | 18 | 529 |
| Phase 14 (Chess Context Engineering) | 119 | 648 |
| Phase 15 (Capture Pipeline Fix) | 50 | 698 |
...
### Project Location
```
src/WitnessDesktop/WitnessDesktop.Tests/
  WitnessDesktop.Tests.csproj    — xUnit + Moq + FluentAssertions (dual-target: net8.0 + net8.0-maccatalyst)
...
dotnet build src/WitnessDesktop/WitnessDesktop.Tests/WitnessDesktop.Tests.csproj \
