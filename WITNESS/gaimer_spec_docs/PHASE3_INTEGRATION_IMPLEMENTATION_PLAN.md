...
1. **User Secrets (Recommended for Development)**
   ```bash
   cd src/WitnessDesktop/WitnessDesktop
...
**File:** `src/WitnessDesktop/WitnessDesktop/WitnessDesktop.csproj`
...
**File:** `src/WitnessDesktop/WitnessDesktop/MauiProgram.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Models/ConnectionState.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Services/IGeminiService.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Services/MockGeminiService.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Services/GeminiLiveService.cs`
...
**Files to Modify:**
- `src/WitnessDesktop/WitnessDesktop/Services/IGeminiService.cs` (add ErrorOccurred)
- `src/WitnessDesktop/WitnessDesktop/Services/MockGeminiService.cs` (update interface)
- `src/WitnessDesktop/WitnessDesktop/MauiProgram.cs` (register GeminiLiveService)
- `src/WitnessDesktop/WitnessDesktop/Models/Agent.cs` (ensure SystemInstruction property exists)
...
**File:** `src/WitnessDesktop/WitnessDesktop/ViewModels/MainViewModel.cs`
...
|------|-------------|-------|--------|
| Task 1 | API Configuration Setup | `MauiProgram.cs`, `WitnessDesktop.csproj`, `config.example.txt` | ✅ Done |
...
- `WITNESS/PROGRESS_LOG.md` - Mark Phase 3 tasks complete
- `WITNESS/FEATURE_LIST.md` - Update network/integration feature status
- `WITNESS/BUG_FIX_LOG.md` - Document any issues found
...
| `WitnessDesktop.csproj` | Add configuration packages |
