...
**File:** `src/WitnessDesktop/WitnessDesktop/Services/Audio/IAudioRecordingService.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Services/Audio/IAudioPlaybackService.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Platforms/MacCatalyst/RecordingService.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Platforms/MacCatalyst/PlaybackService.cs`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Services/Audio/CompositeAudioService.cs`
...
- **Modified**
  - `src/WitnessDesktop/WitnessDesktop/MauiProgram.cs` (MacCatalyst DI now uses the split services)
