...
| Document | Purpose |
|----------|---------|
| `WITNESS/CURSOR_SUBAGENT_ROSTER.md` | Role definitions, invocation protocol |
| `WITNESS/gaimer_spec_docs/CHAT_V2_EXECUTION_TICKET_BOARD.md` | Ticket backlog, sprint breakdown |
| `WITNESS/gaimer_spec_docs/BRAIN_CONTEXT_PIPELINE_SPEC.md` | L1/L2/L3, DTOs, token budget |
| `WITNESS/gaimer_spec_docs/CHAT_V2_MVP_DELIVERABLE.md` | MVP definition, user stories, phases |
| `WITNESS/AGENT_HANDOFF_INSTRUCTIONS.md` | Build, test, project structure |
