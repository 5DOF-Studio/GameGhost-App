...
**Primary Artifact:** `WITNESS/mainview-v2-design.xaml` (swap-in-place draft for `src/WitnessDesktop/WitnessDesktop/MainPage.xaml`)  
...
- V2 draft exists in `WITNESS/mainview-v2-design.xaml` and is now **swap-in-place ready** (compilable XAML, core sections present).
- Current app has:
