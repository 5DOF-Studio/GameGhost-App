...
- `src/WitnessDesktop/WitnessDesktop/ViewModels/MainViewModel.cs` (if needed)
...
**File:** `src/WitnessDesktop/WitnessDesktop/Platforms/Windows/AudioService.cs`
...
**Files to Create:**
- `src/WitnessDesktop/WitnessDesktop/Platforms/Windows/AudioService.cs`

**Files to Modify:**
- `src/WitnessDesktop/WitnessDesktop/MauiProgram.cs` (register Windows AudioService)
...
**File:** `src/WitnessDesktop/WitnessDesktop/Platforms/MacCatalyst/Info.plist`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Platforms/MacCatalyst/Entitlements.plist`
...
**File:** `src/WitnessDesktop/WitnessDesktop/Platforms/MacCatalyst/AudioService.cs`
...
- `src/WitnessDesktop/WitnessDesktop/MauiProgram.cs` (register macOS AudioService)
...
- `WITNESS/PROGRESS_LOG.md` - Mark Phase 2 tasks complete
- `WITNESS/FEATURE_LIST.md` - Update audio feature status
