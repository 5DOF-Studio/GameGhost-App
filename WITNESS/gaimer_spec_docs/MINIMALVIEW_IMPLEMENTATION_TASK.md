...
```
WITNESS/gaimer_spec_docs/gaimer_design_spec.md (Section 6.7)
```

### Color/Style Resources
```
src/WitnessDesktop/WitnessDesktop/Resources/Styles/Colors.xaml
src/WitnessDesktop/WitnessDesktop/Resources/Styles/Styles.xaml
```
