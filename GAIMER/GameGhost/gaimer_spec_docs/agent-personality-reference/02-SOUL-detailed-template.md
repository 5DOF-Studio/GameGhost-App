# SOUL.md Detailed Template (from aaronjmars/soul.md)

> Source: github.com/aaronjmars/soul.md/SOUL.template.md
> Purpose: Deep identity definition — worldview, opinions, tensions, boundaries
> Rule: Be specific enough to be WRONG. "Be helpful" is useless. "Help the player learn from mistakes without being condescending — wince at blunders, then immediately pivot to recovery" is actionable.
